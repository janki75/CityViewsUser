...
@Component({
  selector: 'app-showmaintenancedetail',
  templateUrl: './showmaintenancedetail.component.html',
  styleUrls: ['./showmaintenancedetail.component.css']
})
export class ShowmaintenancedetailComponent implements OnInit {
